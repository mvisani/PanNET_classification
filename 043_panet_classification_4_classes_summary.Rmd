...
As in the 5 classes case, we tried to optimize the number of trees and probes for computational efficiency and avoiding overfitting. 
...
meta_data["CC_epi_four_classes"] <- four_classes
CC_epi_four_classes <- meta_data$CC_epi_four_classes
