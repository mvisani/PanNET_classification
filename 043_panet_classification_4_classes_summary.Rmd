...
# TLDR 
First read `043_panet_classification_5_classes_summary.Rmd` for detailed explanantion of the results and the project. 
...
There is less disagreement between the random forest and the consensus clustering. 
