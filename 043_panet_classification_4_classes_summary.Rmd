...
For further details or questions, please see my [GitHub](https://github.com/mvisani/PanNET_classification) page or send me and email at [marco.visani@unifr.ch](mailto:marco.visani@unifr.ch).
...
test <- apply(scores_plot, 1, find_maximal_value, threshold = 0.1)
test <- t(test)
...
Here accuracy is much higher than for the 5 classes. 
